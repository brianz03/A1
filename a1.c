...
// returns information about memory usage in a string '*str' (it is scuffed)
...
for(int i = 1;i<argc;i++){ //loops through the command line arguments and sets the proper values
   ...
   /*  printf("System Flag = %d\n", showSystem);
    printf("User Flag= %d\n", showUser);
    printf("Graphics Flag = %d\n", showGraphics);
    printf("Sequential Flag = %d\n", sequential);
